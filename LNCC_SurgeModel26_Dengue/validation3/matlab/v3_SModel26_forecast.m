% LNCC Surge Model 26 - Validation 3
...
% Validation 3 
ind_EW25_2024=649+52+52; % time index of EW 25 of 2024 
...
writetable(T,['..\spreadsheets\v3_SModel26_',num2str(state_code(1)),'.csv'],'Delimiter',',')
...
print(['..\plots\v3_SModel26_',UF],'-dpdf')
