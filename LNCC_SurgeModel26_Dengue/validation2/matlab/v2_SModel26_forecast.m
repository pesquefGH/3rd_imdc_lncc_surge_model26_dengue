% LNCC Surge Model 26 - Validation 2
...
% Validation 2 
ind_EW25_2023=649+52; % time index of EW 25 of 2023 
...
mg=param(1);  % mean of value of g (from 2010 to 2023)
sigma=param(2); % standard deviation of value of g (from 2010 to 2023)
...
epiweek=[(202341:202352)';(202401:202440)'];  % epidemic weeks to be forecast 
...
writetable(T,['..\spreadsheets\v2_SModel26_',UF,'.csv'],'Delimiter',',')
...
print(['..\plots\v2_SModel26_',UF],'-dpdf')
