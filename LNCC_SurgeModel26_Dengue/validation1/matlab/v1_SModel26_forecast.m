% LNCC SURGE Model 26 Dengue - Validation 1
...
% 6) Provide a validation 1 target forecast results
...
% Validation 1 
ind_EW25_2022=649; % time index of EW 25 of 2022 
...
% From the time-series 'dcasesfs' of the dengue surges, we obtain an average surge curve.
...
P_est = lsqcurvefit(fun,P,n,typ_DC,[500;0.1;24],[370000;0.5;28],options); % find estimated model parameters 
...
% from EW 41 2022 up to EW 40 of 2023
hold on;
...
print(['..\plots\v1_SModel26_',UF],'-dpdf')
